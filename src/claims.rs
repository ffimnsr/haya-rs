...
pub(crate) struct StandardClaims {
    ...
    /// page containing an image. Note that this URL SHOULD specifically reference a
    ...
    /// addr-spec syntax. The RP MUST NOT rely upon this value being unique, as discussed
    /// in Section 5.7.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub email: Option<String>,

    /// True if the End-User's e-mail address has been verified; otherwise false.
    /// When this Claim Value is true, this means that the OP took affirmative steps to
    /// ensure that this e-mail address was controlled by the End-User at the time the
    /// verification was performed. The means by which an e-mail address is verified
    ...
    /// related function, providing just year can result in varying month and day, so the
    ...
    /// ISO 639-1 Alpha-2 language code in lowercase and an ISO 3166-1 Alpha-2
    ...
    /// as the separator rather than a dash, for example, en_US; Relying Parties
    ...
    /// of this Claim, for example, +1 (425) 555-1212 or +56 (2) 687 2400. If the
    /// phone number contains an extension, it is RECOMMENDED that the extension
    /// be represented using the RFC 3966 extension syntax, for example,
    ...
    /// is a JSON structure containing some or all of the members defined in
    /// Section 5.1.1.
    #[serde(skip_serializing_if = "Option::is_none")]
