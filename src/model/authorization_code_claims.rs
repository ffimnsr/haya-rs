...
pub(crate) struct AuthorizationCodeClaims {
    /// Subject identifier.
    #[serde(rename = "sub")]
    pub subject: Uuid,
    ...
    /// Audience(s) that this ID token is inteded for. Currently client id which
    /// is a client identifier for the OAuth 2.0 client that requested this
    /// token.
    #[serde(rename = "aud")]
    pub audience: Uuid,
